...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name, chkpt_dir='tmp/ddpg'):
        ...
        self.bn2 = nn.LayerNorm(self.fc2_dims) #use Layer Normalization instead of Batch normalization
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, n_actions, name, chkpt_dir='tmp/ddpg'):
        ...
        #self.bn1 = nn.BatchNorm1d(self.fc1_dims) => for batchnorms
    ...
    def forward(self, state):
        ...
        x = self.bn2(x)
        x = F.relu(x)
        x = T.tanh(self.mu(x))      #bounded by +-1 in action space 
